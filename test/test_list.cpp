...
TEST(List, check_removeDuplicate_1) {
	List<int> ls;
	ls.append(2);
	ls.append(2);
	ls.append(2);
...
TEST(List, check_removeDuplicate_2) {
	List<int> ls;
	ls.append(2);
	ls.append(2);
	ls.append(1);
...
TEST(List, check_removeDuplicate_3) {
	List<int> ls;
	ls.append(2);
	ls.removeDuplicate();
...
TEST(List, check_removeDuplicate_4) {
	List<int> ls;
	ls.removeDuplicate();
...
TEST(List, check_removeDuplicate_5) {
	List<int> ls;
	ls.append(7);
	ls.append(6);
	ls.append(5);
...
TEST(List, check_removeDuplicate_6) {
	List<int> ls;
	ls.append(7);
	ls.append(6);
	ls.append(5);
...
TEST(List, check_removeDuplicate_7) {
	List<int> ls;
	ls.append(7);
	ls.append(6);
	ls.append(5);
...
TEST(List, check_removeDuplicate_8) {
	List<int> ls;
	ls.append(-7);
	ls.append(-7);
	ls.append(-7);
...
TEST(List, check_removeDuplicate_9) {
	List<int> ls;
	ls.append(-7);
	ls.append(-7);
	ls.append(-7);
